...
public class MyAppGlideModule extends AppGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        ...
        com.sogou.groupwenwen.gifdecode.ByteBufferGifDecoder byteBufferGifDecoder =
                new com.sogou.groupwenwen.gifdecode.ByteBufferGifDecoder(context, imageHeaderParsers, glide.getBitmapPool(), glide.getArrayPool());
